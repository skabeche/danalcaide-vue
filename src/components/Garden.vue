<template>
  <div class="garden relative -z-10 -bottom-0.5">
    ...
    <div @mousemove="gardenMove($event)" @mouseenter="gardenEnter($event)" @mouseleave="gardenOut($event)" @wheel="gardenOut($event)" @touchmove="gardenMove($event)" id="plants" class="plants cursor-none absolute z-30 -left-[140px] lg:-left-[220px] bottom-0 w-[550px] sm:w-[calc(100%+550px)] h-[240px] bg-plants bg-[length:auto_200px] bg-[100px_bottom] bg-no-repeat">
